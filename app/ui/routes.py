...
<head>
  ...
  <style>
    @font-face {
      ...
      font-style: normal;
      font-weight: 700;
      src: url('/static/fonts/BarlowCondensed-700.ttf') format('truetype');
      font-display: swap;
    }
    @font-face {
      font-family: 'Barlow Condensed';
      font-style: normal;
      font-weight: 800;
      src: url('/static/fonts/BarlowCondensed-800.ttf') format('truetype');
      font-display: swap;
    }
    @font-face {
      ...
      font-style: normal;
      font-weight: 400;
      src: url('/static/fonts/Epilogue-400.ttf') format('truetype');
      font-display: swap;
    }
    @font-face {
      font-family: 'Epilogue';
      font-style: normal;
      font-weight: 500;
      src: url('/static/fonts/Epilogue-500.ttf') format('truetype');
      font-display: swap;
    }
    @font-face {
      font-family: 'Epilogue';
      font-style: normal;
      font-weight: 600;
      src: url('/static/fonts/Epilogue-600.ttf') format('truetype');
      font-display: swap;
    }
    @font-face {
      font-family: 'DM Mono';
      font-style: normal;
      font-weight: 400;
      src: url('/static/fonts/DMMono-400.ttf') format('truetype');
      font-display: swap;
    }
    @font-face {
      font-family: 'DM Mono';
      font-style: normal;
      font-weight: 500;
      src: url('/static/fonts/DMMono-500.ttf') format('truetype');
      font-display: swap;
    }
    :root {
      --ink: #0d0d0f;
      ...
      --violet-light: #eee8fb;
      --violet-mid: #9070d4;
      --obj-scope: var(--violet);
      --obj-scope-soft: var(--violet-light);
      --obj-campaign: var(--cobalt);
      --obj-campaign-soft: var(--cobalt-light);
      --obj-deliverable: var(--amber);
      --obj-deliverable-soft: var(--amber-light);
      --obj-stage: var(--sage);
      ...
      --space-5: 24px;
      --space-6: 40px;
      --capacity-user-col-width: 300px;
      --capacity-time-col-width: 220px;
      --header-offset: 72px;
      --footer-offset: 0px;
      --rail-gap: 12px;
      --color-status-risk: var(--rust);
      --color-status-review: var(--amber);
      --color-status-blocked: var(--violet);
      --color-status-live: var(--sage);
      --color-status-done: var(--cobalt);
      --color-status-neutral: var(--ink-2);
    }
    * { box-sizing: border-box; }
    body {
      ...
      --screen-accent: var(--cobalt);
      --screen-accent-soft: var(--cobalt-light);
    }
    body.screen-home { --screen-accent: var(--sage); --screen-accent-soft: var(--sage-light); }
    body.screen-my-work { --screen-accent: var(--amber); --screen-accent-soft: var(--amber-light); }
    body.screen-deals { --screen-accent: var(--cobalt); --screen-accent-soft: var(--cobalt-light); }
    body.screen-campaigns { --screen-accent: var(--violet); --screen-accent-soft: var(--violet-light); }
    body.screen-gantt { --screen-accent: var(--cobalt); --screen-accent-soft: var(--cobalt-light); }
    body.screen-reviews { --screen-accent: var(--amber); --screen-accent-soft: var(--amber-light); }
    body.screen-risks { --screen-accent: var(--rust); --screen-accent-soft: var(--rust-light); }
    body.screen-capacity { --screen-accent: var(--cobalt); --screen-accent-soft: var(--cobalt-light); }
    body.screen-admin { --screen-accent: var(--violet); --screen-accent-soft: var(--violet-light); }
    :focus-visible {
    ...
    .sub { margin-top: 4px; color: var(--ink-3); font-size: 12px; font-family: 'DM Mono', ui-monospace, monospace; }
    ...
    .demo-rail {
      position: fixed;
      top: calc(var(--header-offset) + var(--rail-gap));
      bottom: calc(var(--footer-offset) + var(--rail-gap));
      left: 16px;
      width: 320px;
      z-index: 50;
      display: grid;
    ...
    .card {
      background:
        linear-gradient(180deg, var(--screen-accent-soft) 0, var(--screen-accent-soft) 4px, #ffffff 4px, #ffffff 100%);
      border: 1px solid var(--line-strong);
      border-radius: var(--radius-lg);
      padding: var(--space-4);
      box-shadow: 0 2px 10px rgba(13, 13, 15, 0.06);
      transition: box-shadow 180ms ease, transform 180ms ease;
    }
    .card:hover { box-shadow: 0 8px 22px rgba(13, 13, 15, 0.08); }
    .kpi {
      margin-top: 4px;
      font-family: 'Barlow Condensed', 'Epilogue', sans-serif;
      font-size: 36px;
    ...
    textarea {
      ...
      background: #ffffff;
      color: var(--ink);
      box-shadow: inset 0 0 0 1px rgba(13, 13, 15, 0.04);
    }
    .line-list {
      display: grid;
      gap: 8px;
    ...
    .queue-card {
      ...
      padding: var(--space-3);
      background: #ffffff;
      border-left: 4px solid var(--screen-accent);
    }
    .queue-title {
      margin: 0 0 8px 0;
      font-size: 0.95rem;
    ...
    .gantt-grid {
      display: grid;
      grid-template-columns: var(--gantt-object-col-width, 280px) calc(var(--gantt-unit-width, 240px) * var(--gantt-cols, 3));
      width: max-content;
      min-width: calc(var(--gantt-object-col-width, 280px) + (var(--gantt-unit-width, 240px) * 3));
      align-items: stretch;
    }
    .gantt-head {
      font-size: 12px;
    ...
    .gantt-head.time-head {
      display: grid;
      grid-template-columns: repeat(var(--gantt-cols, 3), var(--gantt-unit-width, 240px));
      gap: 0;
      min-width: 0;
    }
    .gantt-head-time-cell {
      padding: 0 4px;
      white-space: nowrap;
      overflow: hidden;
      text-overflow: ellipsis;
    ...
    .gantt-head-time-cell:first-child {
      border-left: 0;
    }
    .gantt-row-label {
      border-bottom: 0.5px solid var(--line);
      ...
      min-height: var(--gantt-row-height, 40px);
      max-height: var(--gantt-row-height, 40px);
    }
    .gantt-row-label.stage-row {
      cursor: pointer;
      user-select: none;
    }
    .gantt-row-label > span:last-child {
      min-width: 0;
      overflow: hidden;
      text-overflow: ellipsis;
      white-space: nowrap;
    ...
    .gantt-track {
      ...
      background:
        repeating-linear-gradient(
          ...
          rgba(13, 13, 15, 0.06) calc(100% / var(--gantt-cols, 12) - 1px),
          rgba(13, 13, 15, 0.06) calc(100% / var(--gantt-cols, 12))
        );
    }
    .gantt-today-line {
      position: absolute;
    ...
    .gantt-status-dot.status-not-started,
    .gantt-status-dot.status-cancelled {
      background: var(--surface-3);
    }
    .gantt-status-dot.status-in-progress {
      background: var(--cobalt);
    }
    .gantt-status-dot.status-done {
      background: var(--sage);
    }
    .gantt-status-dot.status-on-hold {
      background: var(--amber);
    }
    .gantt-status-dot.status-blocked {
      background: var(--rust);
    }
    .gantt-status-dot.status-blocked-dependency {
      background: var(--violet);
    }
    .gantt-owner-pill .user-pill {
      display: inline-flex;
      align-items: center;
      justify-content: center;
      min-width: 22px;
    ...
    .gantt-bar-wrap.overflow .gantt-bar-side {
      display: inline-flex;
      align-items: center;
      align-self: center;
      margin-left: 0;
    ...
    .gantt-bar-wrap.overflow .gantt-bar {
      font-size: 0;
    }
    .gantt-step-suffix {
      display: inline-flex;
    ...
    .gantt-health-pill.ok {
      background: var(--sage-light);
      color: var(--sage);
    }
    .gantt-health-pill.warn {
      background: var(--amber-light);
      color: var(--amber);
    }
    .gantt-health-pill.risk {
    ...
    .module-card[data-module='scope']::before,
    .module-popover[data-module='scope']::before { background: var(--obj-scope); }
    .module-card[data-module='campaign']::before,
    .module-popover[data-module='campaign']::before { background: var(--obj-campaign); }
    .module-card[data-module='deliverable']::before,
    .module-popover[data-module='deliverable']::before { background: var(--obj-deliverable); }
    .module-card[data-module='stage']::before,
    .module-popover[data-module='stage']::before { background: var(--obj-stage); }
    .module-card[data-module='step']::before,
    .module-popover[data-module='step']::before { background: var(--obj-step); }
    .module-body {
      padding: 10px 12px;
      display: grid;
      gap: 8px;
    ...
    .module-card[data-module='scope'] .module-icon,
    .module-popover[data-module='scope'] .module-icon,
    .list-module-row[data-module='scope'] .module-icon {
      color: var(--obj-scope);
      background: var(--obj-scope-soft);
    }
    .module-card[data-module='campaign'] .module-icon,
    .module-popover[data-module='campaign'] .module-icon,
    .list-module-row[data-module='campaign'] .module-icon {
      color: var(--obj-campaign);
      background: var(--obj-campaign-soft);
    }
    .module-card[data-module='deliverable'] .module-icon,
    .module-popover[data-module='deliverable'] .module-icon,
    .list-module-row[data-module='deliverable'] .module-icon {
      color: var(--obj-deliverable);
      background: var(--obj-deliverable-soft);
    }
    .module-card[data-module='stage'] .module-icon,
    .module-popover[data-module='stage'] .module-icon,
    .list-module-row[data-module='stage'] .module-icon {
      color: var(--obj-stage);
      background: var(--obj-stage-soft);
    }
    .module-card[data-module='step'] .module-icon,
    .module-popover[data-module='step'] .module-icon,
    .list-module-row[data-module='step'] .module-icon {
      color: var(--obj-step);
      background: var(--obj-step-soft);
    }
    .module-icon svg {
      width: 12px;
      height: 12px;
    ...
    .module-option-btn:hover {
      background: var(--surface-2);
    }
    .module-option-btn svg {
      width: 12px;
      height: 12px;
      display: block;
    }
    .module-head-controls {
      display: inline-flex;
      align-items: center;
      gap: 6px;
    }
    ...
    .module-title {
      ...
      word-break: break-word;
      flex: 0 1 auto;
      max-width: min(44ch, 58vw);
      min-width: 8ch;
    }
    .module-card:not([open]) .module-title {
      white-space: nowrap;
      overflow: hidden;
      text-overflow: clip;
    ...
    .module-card:not([open]) .module-subtitle { display: none; }
    .card-progress {
      display: grid;
      gap: 6px;
      width: 100%;
    ...
    .progress-segment.status-done { background: var(--sage); }
    .progress-segment.status-in-progress { background: var(--cobalt); }
    .progress-segment.status-on-hold { background: var(--amber); }
    .progress-segment.status-blocked { background: var(--rust); }
    .progress-segment.status-blocked-dependency { background: var(--violet); }
    .progress-segment.status-not-started,
    .progress-segment.status-cancelled {
      background: #a5a6ad;
    }
    .progress-segment.hatched {
      background-image:
        repeating-linear-gradient(
          -45deg,
    ...
    .module-pair > span:first-child {
      color: var(--ink-3);
      font-weight: 600;
      white-space: nowrap;
      flex: 0 0 auto;
    }
    .module-pair > *:nth-child(2) {
      min-width: 0;
      flex: 0 1 auto;
    }
    .pill-dropdown {
    ...
    .pill-dropdown-trigger:focus-visible {
      outline: 2px solid var(--cobalt);
      outline-offset: 2px;
      border-radius: 999px;
    }
    .pill-dropdown-caret-inline {
      font-size: 10px;
      color: inherit;
      line-height: 1;
      display: inline-flex;
    ...
    .pill-dropdown.open .pill-dropdown-caret-inline {
      transform: rotate(180deg);
    }
    .tag.has-dropdown-caret {
      display: inline-flex;
      align-items: center;
      gap: 0;
    }
    .user-pill.has-dropdown-caret {
      display: inline-flex;
      align-items: center;
      gap: 0;
    }
    ...
    .pill-dropdown-option:focus-visible {
      outline: 2px solid var(--cobalt);
      outline-offset: 2px;
      border-radius: 999px;
    }
    .pill-dropdown-option.owner-option {
      justify-content: space-between;
      border-radius: 8px;
      padding: 6px 8px;
      border: 1px solid transparent;
    }
    .pill-dropdown-option.owner-option:hover {
      background: var(--surface-2);
      border-color: var(--line);
    }
    .owner-option-main {
    ...
    .admin-users-table td .role-pill-grid {
      max-width: 500px;
    }
    .admin-users-wrap {
      width: 100%;
    ...
    .campaign-id-line > span:first-child {
      color: var(--ink-3);
      font-weight: 600;
      white-space: nowrap;
    }
    ...
    .module-card:not([open]) .module-head-left {
      display: grid;
      grid-template-columns: 10px minmax(18ch, 42ch) minmax(0, 1fr);
      align-items: center;
      column-gap: 6px;
    }
    .module-card:not([open]) .module-summary-grid {
      display: grid;
      align-items: center;
      column-gap: 8px;
      min-width: 0;
    ...
    .module-card:not([open]) .summary-pill-slot {
      min-width: 0;
      width: 100%;
    }
    .module-card:not([open]) .summary-pill-slot .tag {
      width: 100%;
      justify-content: center;
    }
    .module-card:not([open]) .summary-slot {
      min-width: 0;
      overflow: hidden;
      text-overflow: clip;
      white-space: nowrap;
    }
    .module-card:not([open]) .summary-slot.hidden {
      display: none !important;
    }
    .module-card:not([open]) .summary-pill-slot.hidden {
      display: none !important;
    }
    .module-card:not([open]) .step-summary-grid { width: 100%; }
    .module-card:not([open]) .stage-summary-grid { width: 100%; }
    .module-card:not([open]) .deliverable-summary-grid { width: 100%; }
    .module-card:not([open]) .scope-summary-grid { width: 100%; }
    .module-card:not([open]) .scope-summary-grid .scope-id {
      margin-left: auto;
      white-space: nowrap;
      text-align: right;
    }
    .module-summary-inline.with-right {
      justify-content: space-between;
      gap: 12px;
      width: 100%;
    }
    ...
    .module-card[data-module='campaign']:not([open]) .campaign-summary-inline {
      display: grid;
    ...
    .module-card:not([open]) .slot-timeframe {
      display: inline-flex;
      align-items: center;
      gap: 0;
      min-width: 0;
    ...
    .module-card:not([open]) .slot-timeframe .timeframe-start-part,
    .module-card:not([open]) .slot-timeframe .timeframe-end-part {
      white-space: nowrap;
    }
    .module-card[data-module='campaign']:not([open]) .campaign-summary-owner {
      min-width: 0;
      overflow: hidden;
      text-overflow: clip;
      white-space: nowrap;
    ...
    .module-card:not([open]) .module-summary-right {
      margin-left: 0;
    }
    .module-card:not([open]) .module-summary-right.hidden {
      display: none !important;
    }
    .module-card:not([open]) [data-slot='campaign_id'] {
      justify-self: end;
      text-align: right;
    }
    .module-summary-text {
    ...
    .module-card.summary-overflow:not([open]) .module-summary-inline {
      outline: none;
    }
    .module-card.summary-overflow-2:not([open]) .module-summary-inline .summary-owner {
      display: none;
    }
    .module-kind-pill { display: none; }
    .module-card:not([open]) > .module-head .module-kind-pill { display: none !important; }
    .module-card[open] > .module-head .module-kind-pill { display: inline-flex; }
    .module-card[open] > .module-head .module-summary-inline { display: none; }
    .module-card[open] > .module-head .module-chevron { transform: rotate(90deg); }
    .list-module {
      display: grid;
      gap: 6px;
    }
    ...
    .list-module-row.depth-1 { margin-left: 16px; }
    .list-module-row.depth-2 { margin-left: 32px; }
    .list-module-row.depth-3 { margin-left: 48px; }
    ...
    .ops-accordion > summary::-webkit-details-marker { display: none; }
    .ops-accordion > summary::marker { content: ""; }
    .ops-accordion > summary::before {
      content: "▸";
      display: inline-block;
      width: 10px;
      color: var(--ink-2);
    ...
    .ops-accordion[open] > summary::before {
    ...
    button:hover { box-shadow: inset 0 0 0 999px rgba(255, 255, 255, 0.25); opacity: 1; }
    button:active { transform: translateY(1px); }
    button.primary { background: var(--cobalt); color: #fff; border-color: var(--cobalt); }
    button.secondary { background: #efefed; color: var(--ink-2); border-color: var(--line-strong); }
    button.ghost { background: #f6f5f2; color: var(--ink-2); border-color: var(--line); }
    button.danger { background: #fff5f2; color: var(--rust); border-color: var(--rust-mid); }
    input, select {
      border: 1px solid var(--line-strong);
      border-radius: var(--radius);
      padding: 8px 10px;
    ...
    .capacity-matrix col.cap-col-user { width: var(--capacity-user-col-width); }
    .capacity-matrix col.cap-col-time { width: var(--capacity-time-col-width); }
    .capacity-matrix th,
    .capacity-matrix td {
      border-bottom: 0.5px solid var(--line);
      border-right: 0.5px solid var(--line);
      vertical-align: top;
      background: var(--surface);
      width: var(--capacity-time-col-width);
      min-width: var(--capacity-time-col-width);
      max-width: var(--capacity-time-col-width);
      padding: 10px;
    }
    .capacity-matrix th:first-child,
    .capacity-matrix td:first-child {
      width: var(--capacity-user-col-width);
      min-width: var(--capacity-user-col-width);
      max-width: var(--capacity-user-col-width);
      position: sticky;
      left: 0;
      z-index: 4;
      background: var(--surface-2);
    ...
    .capacity-matrix thead th {
      position: sticky;
      top: 0;
      z-index: 3;
      background: var(--surface-2);
    }
    .capacity-matrix thead th:first-child {
      z-index: 5;
    }
    .capacity-matrix thead tr.cap-month-head th {
      top: 0;
      z-index: 5;
      font-size: 12px;
    ...
    .capacity-matrix thead tr.cap-week-head th {
      top: 32px;
      z-index: 4;
    }
    .cap-user {
    ...
    .cap-cell-btn:hover { box-shadow: none; }
    .cap-main {
      display: flex;
      justify-content: space-between;
      align-items: center;
    ...
    .cap-hours { font-weight: 700; font-size: 0.93rem; }
    .cap-preview { display: grid; gap: 4px; }
    .cap-preview-line {
      font-size: 12px;
      color: var(--ink-2);
      white-space: nowrap;
    ...
    .cap-preview-more { font-size: 12px; color: var(--cobalt); font-weight: 700; font-family: 'DM Mono', ui-monospace, monospace; }
    .cap-pill-row td { background: var(--surface-2); }
    .cap-pill-label {
      font-size: 0.93rem;
      color: var(--ink-3);
      font-weight: 600;
    ...
    .cap-pill-track {
      ...
      background: repeating-linear-gradient(
        to right,
        transparent,
        transparent calc(var(--capacity-time-col-width) - 1px),
        rgba(13, 13, 15, 0.06) calc(var(--capacity-time-col-width) - 1px),
        rgba(13, 13, 15, 0.06) var(--capacity-time-col-width)
      );
      border-radius: 6px;
      padding: 4px 0;
      overflow: visible;
    ...
    .cap-pill-track.subdivided {
      background-image:
        repeating-linear-gradient(
          to right,
          transparent,
          transparent calc(var(--capacity-time-col-width) - 1px),
          rgba(13, 13, 15, 0.08) calc(var(--capacity-time-col-width) - 1px),
          rgba(13, 13, 15, 0.08) var(--capacity-time-col-width)
        ),
        repeating-linear-gradient(
          to right,
          transparent,
          transparent calc((var(--capacity-time-col-width) / var(--cap-subunits-per-col)) - 1px),
          rgba(13, 13, 15, 0.04) calc((var(--capacity-time-col-width) / var(--cap-subunits-per-col)) - 1px),
          rgba(13, 13, 15, 0.04) calc(var(--capacity-time-col-width) / var(--cap-subunits-per-col))
        );
    }
    .cap-pill-track.quarter-micro {
      background-image:
        ...
        repeating-linear-gradient(
          to right,
          transparent,
          transparent calc((var(--capacity-time-col-width) / 5) - 1px),
          rgba(13, 13, 15, 0.05) calc((var(--capacity-time-col-width) / 5) - 1px),
          rgba(13, 13, 15, 0.05) calc(var(--capacity-time-col-width) / 5)
        );
    }
    .cap-pill-wrap {
      position: relative;
    ...
    .cap-pill-wrap.dot-wrap {
      justify-content: center;
    }
    .cap-pill-wrap > .cap-pill {
      width: 100%;
    }
    .cap-pill {
      border: 0;
      ...
      min-height: 26px;
      text-align: left;
      box-shadow: inset 0 0 0 0.5px rgba(13, 13, 15, 0.06), 0 1px 0 rgba(13,13,15,0.05);
    }
    .cap-pill.tone-cobalt {
      background: var(--cobalt-light);
      color: var(--cobalt);
    }
    .cap-pill.tone-sage {
    ...
    .cap-pill-side {
      ...
      text-overflow: ellipsis;
      pointer-events: none;
      background: linear-gradient(90deg, rgba(250,248,245,0.92), rgba(250,248,245,0));
      padding-left: 2px;
    }
    .capacity-cell-over {
      background: linear-gradient(180deg, rgba(217, 79, 44, 0.08), rgba(217, 79, 44, 0.03));
    }
    .capacity-cell-near {
      background: linear-gradient(180deg, rgba(200, 125, 14, 0.08), rgba(200, 125, 14, 0.03));
    }
    .capacity-cell-ok {
      background: linear-gradient(180deg, rgba(45, 122, 90, 0.08), rgba(45, 122, 90, 0.03));
    }
    .cap-popover {
      position: fixed;
      z-index: 12;
    ...
    .cap-popover .module-card,
    .cap-popover .module-popover {
      width: 100%;
      max-width: 100%;
      min-width: 0;
      overflow: hidden;
    }
    .cap-popover .module-head,
    .cap-popover .module-head-left,
    .cap-popover .module-head-right,
    .cap-popover .module-fields,
    .cap-popover .module-row,
    .cap-popover .module-pair {
      min-width: 0;
      max-width: 100%;
    }
    .cap-popover .module-pair > *:nth-child(2) {
      min-width: 0;
      max-width: 100%;
      white-space: normal;
      overflow-wrap: anywhere;
    ...
    .cap-popover .module-row input,
    .cap-popover .module-row select,
    .cap-popover .module-row textarea {
      min-width: 0;
      width: 100%;
      max-width: 100%;
    }
    .cap-popover .module-row input[type='date'] {
      width: 10rem;
      min-width: 10rem;
      max-width: 10rem;
    }
    ...
    .module-popover .module-head {
      cursor: default;
      align-items: center;
      justify-content: space-between;
      width: 100%;
    }
    .module-popover .module-head-left {
      width: auto;
      flex: 1 1 auto;
      min-width: 0;
      align-items: center;
    ...
    .module-popover .module-head-right {
      margin-left: auto;
      flex: 0 0 auto;
      max-width: 40%;
      min-width: 0;
    ...
    .tag.warn, .tag.review { background: var(--amber-light); color: var(--amber); }
    .tag.risk { background: var(--rust-light); color: var(--rust); }
    .tag.blocked { background: var(--violet-light); color: var(--violet); }
    .tag.done { background: var(--cobalt-light); color: var(--cobalt); }
    .tag.neutral { background: var(--surface-3); color: var(--ink-2); }
    .tag.status-in-progress { background: var(--cobalt-light); color: var(--cobalt); }
    .tag.status-done { background: var(--sage-light); color: var(--sage); }
    .tag.status-cancelled { background: var(--surface-3); color: var(--ink-2); }
    .tag.status-on-hold { background: var(--amber-light); color: var(--amber); }
    .tag.status-blocked { background: var(--rust-light); color: var(--rust); }
    .tag.status-blocked-dependency { background: var(--violet-light); color: var(--violet); }
    .tag.obj-scope { background: var(--obj-scope-soft); color: var(--obj-scope); }
    .tag.obj-campaign { background: var(--obj-campaign-soft); color: var(--obj-campaign); }
    .tag.obj-deliverable { background: var(--obj-deliverable-soft); color: var(--obj-deliverable); }
    .tag.obj-stage { background: var(--obj-stage-soft); color: var(--obj-stage); }
    .tag.obj-step { background: var(--obj-step-soft); color: var(--obj-step); }
    .timeline-title {
      margin: 0 0 8px 0;
      font-size: 12px;
    ...
    .activity-dot.risk { background: var(--rust); }
    .activity-dot.review { background: var(--amber); }
    .activity-dot.done { background: var(--sage); }
    .activity-dot.info { background: var(--cobalt); }
    .activity-card-title { font-weight: 700; font-size: 12px; margin-bottom: 2px; }
    .activity-card-meta { font-size: 12px; color: var(--ink-3); margin-bottom: 3px; font-family: 'DM Mono', ui-monospace, monospace; }
    .risk-flag-list {
      display: grid;
      gap: 10px;
    }
    ...
    .risk-flag.high { background: var(--rust-light); border-color: rgba(217,79,44,0.32); }
    .risk-flag.medium { background: var(--amber-light); border-color: rgba(200,125,14,0.32); }
    .risk-flag.low { background: var(--cobalt-light); border-color: rgba(27,63,232,0.32); }
    .risk-flag-head {
      display: flex;
      justify-content: space-between;
      align-items: center;
    ...
    @media (max-width: 980px) {
      ...
      .demo-rail {
        ...
        width: auto;
        top: auto;
        bottom: calc(var(--footer-offset) + 8px);
        max-height: 42vh;
